import type { EmailMessage, EmailProvider } from '../../core/events.js';
...
const provider: EmailProvider = Object.freeze({
  ...
  sendMessage: async (message: EmailMessage) => { console.info('reserva email-none: message dropped', { to: message.to, subject: message.subject }); },
});
