...
export const defaultMessages = {
  ...
  'admin.changeValue': 'Change',
  'settingStmt.schedule': 'Departs {from} to {to}, every {n} minutes',
  'settingStmt.days': 'Runs {days}',
  ...
  'admin.sectionHoursHint': 'The first and last departure customers can book, per service.',
